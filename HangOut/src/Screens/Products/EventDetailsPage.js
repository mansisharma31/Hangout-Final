...
export const EventDetailsPage = () => {
    ...
    let eventData = eventsArray.find((data) => data.id == id);
    console.log(eventData)
    if(!eventData){
        eventData = eventsArray.find((data)=> data.title == id);
    }
    console.log(" data 2", eventData);
        ...
        <div className="bg-gradient-to-b from-[#FAF7F0] to-[#D8D2C2] min-h-screen mt-12">
                ...
                <div className="grid grid-cols-3 gap-6 mb-6">
                    <div className="col-span-2 relative overflow-hidden rounded-lg shadow-lg transition-transform transform hover:scale-105">
                        ...
                        <div className="absolute bottom-4 left-4 text-white">
                            <h2 className="text-xl font-bold">Experience the Best Events</h2>
                        </div>
                    </div>
            ...
            <div className="container mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-3 gap-12 py-12">
                ...
                <aside className="hidden lg:block lg:sticky lg:top-20 bg-white p-6 rounded-lg shadow-xl h-fit">
                    ...
                    <p className="text-sm text-gray-500 mt-4">Date & Time</p>
                    <p className="text-sm text-black">{eventData.timings}</p>
                    <p className="text-sm text-gray-500 mt-4">Location</p>
                    <p className="text-sm text-black">{eventData.locations.join(", ")}</p>
                    ...
                    <div>
                        ...
                        {activeTab === "location" && (
                            <div className="bg-white p-6 rounded-lg shadow-lg mb-6">
                                ...
                                <a href={eventData.mapLink} className="text-blue-600 mt-2 block hover:underline break-words" style={{ wordBreak: "break-word", overflowWrap: "break-word" }}>{eventData.mapLink}</a>
